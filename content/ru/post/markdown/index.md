---
title: Markdown
subtitle: Статья о синтаксисе языка разметки markdown

# Summary for listings and search engines
summary: Статья о синтаксисе языка разметки markdown
...
image:
  caption: 'Источник картинки: [**Unsplash**](https://unsplash.com/photos/J5yoGZLdpSI)'
  focal_point: ''
  placement: ''
  preview_only: false
...
<br>
--------<br>
Источник: https://gist.github.com/Jekins/2bf2d0638163f1294637#file-markdown-docs-md
